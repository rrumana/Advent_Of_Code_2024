...
Today's part two was HARD.

I really wanted to do only efficient solutions this year, not brute force, but I spent houyrs debugging another solution that only involved one iteration, but I could not figure it out.\
&emsp;\
&emsp; 
