...
My logic is a bit of a monstrosity. There was prohably a better way to do this, but making 5 or 8 relatively detailed if statements was just so easy, and allowed me to have an O(n) solutio since it is just one iteration through each character. I will come back and update this if I think of a better solution to this problem.
