...
Today's challenge was pretty easy to solve, although I am not sure how to optimize these types of problems. Today was yet another day where my solution took over a second for part 2. This seems really terrible performace for a low level language like rust, but I don't know of an efficient method for solving this problem.\
&emsp;\
&emsp; 
